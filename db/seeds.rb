...
file = open('https://s3-us-west-1.amazonaws.com/instagg-dev/zK2LQaap5RJczwJ2ccZD3jys')
post2.photo.attach(io: file, filename: 'post2.png')
post2.save!

post3 = Post.create(caption: '', user_id: user1.id)
file = open('https://s3-us-west-1.amazonaws.com/instagg-dev/jQUH5JWDrKwADt9vRJL3fWQD')
post3.photo.attach(io: file, filename: 'post3.png')
post3.save!

post4 = Post.create(caption: 'HAHA', user_id: user2.id)
file = open('https://s3-us-west-1.amazonaws.com/instagg-dev/6UxfZzyFAiwPLBvotcgnHVUw')
post4.photo.attach(io: file, filename: 'post4.png')
post4.save!

post5 = Post.create(caption: '', user_id: user2.id)
file = open('https://s3-us-west-1.amazonaws.com/instagg-dev/8QdTjdA85TWiLRFe5EagvhcC')
post5.photo.attach(io: file, filename: 'post5.png')
post5.save!

post6 = Post.create(caption: '', user_id: user3.id)
file = open('https://s3-us-west-1.amazonaws.com/instagg-dev/HVJ217mNMiep4RcEAdomazth')
post6.photo.attach(io: file, filename: 'post6.png')
post6.save!

post7 = Post.create(caption: '666', user_id: user4.id)
file = open('https://s3-us-west-1.amazonaws.com/instagg-dev/c6wkuK33k5Km137EBMF7PQq8')
